export default {
  ...
  servers: {
    ...
    // Server details page new translations
    ...
    // ServerFormDialog related translations
  ...
  openapi: {
    ...
    manual: {
      ...
      messages: {
        ...
        createFailed: "Manual endpoint create failed: {error}",
      },
    },
    uploading: "Uploading...",
  ...
  endpointRegistry: {
    ...
    searchPlaceholder: "Search by server URL / name / path",
