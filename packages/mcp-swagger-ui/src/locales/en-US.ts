export default {
  ...
  openapi: {
    ...
    confirmDeleteSpec: 'Are you sure you want to delete specification "{name}"?',
    ...
    uploadSuccessValidate: 'Document uploaded successfully, please click validate button to validate',
    uploadFailed: 'Upload failed: {error}',
    fileReadFailed: 'File read failed',
    selectDocumentFirst: 'Please select a document or enter OpenAPI specification content first',
    fixErrorsFirst: 'Current specification validation failed, please fix errors first',
    ...
    importSuccessValidate: 'Document imported successfully, please click validate button to validate',
