export default {
  ...
  endpointRegistry: {
    title: "API注册中心",
    subtitle:
      "按 Server URL（baseUrl）分组管理手工 Endpoint，与 OpenAPI 文档管理解耦。",
    searchPlaceholder: "按 Server URL / 名称 / 路径搜索",
    empty: "暂无手工 Endpoint。",
    ...
    validation: {
      ...
      methodRequired: "请选择 HTTP Method",
      pathRequired: "请输入 Path",
      pathSlashRequired: "Path 必须以 / 开头",
    },
    messages: {
      submitting: "提交中...",
      loadFailed: "加载 Endpoint Registry 失败",
      ...
      readinessBlocked: "发布准入检查：阻断（{reasons}）",
