...
export function useConfirmation() {
  ...
  const confirmDangerousAction = (
    ...
    console.log(
      "🛑 [FRONTEND DEBUG] confirmDangerousAction called with message:",
      message,
    );

    return ElMessageBox.confirm(message, options.title || "危险操作确认", {
  ...
  const quickConfirm = (
    ...
    return ElMessageBox.confirm(options.message, options.title || "确认", {
